...
export const courseGroupsApi = {
  ...
  /** Добавить участника в группу (ученик или модератор) */
  addGroupMember: (courseId: number, groupId: number, accountId: number) =>
      api.post<CourseGroupResponse>(`/courses/${courseId}/groups/${groupId}/members/${accountId}`),

  /** Удалить участника из группы */
  removeGroupMember: (courseId: number, groupId: number, accountId: number) =>
      api.delete<CourseGroupResponse>(`/courses/${courseId}/groups/${groupId}/members/${accountId}`),
};