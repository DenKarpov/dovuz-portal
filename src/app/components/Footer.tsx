      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <Link to="/" className="inline-flex items-center gap-3 mb-4 group">
            <div className="size-10 bg-gradient-to-br from-violet-600 to-indigo-700 rounded-xl flex items-center justify-center">
              <GraduationCap className="size-5 text-white" />
            </div>
            <div>
              <p className="text-white font-bold text-lg leading-none">МосПолитех</p>
              <p className="text-gray-500 text-xs mt-0.5">Довузовская подготовка</p>
            </div>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><Link to="/directions" className="hover:text-white transition-colors">Учебные материалы</Link></li>
            <li><Link to="/projects" className="hover:text-white transition-colors">Проекты</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="text-white font-semibold mb-4">🔗 Ссылки</h4>
          <ul className="space-y-2.5 text-sm">
            <li><a href="https://mospolytech.ru" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">Сайт МосПолитеха</a></li>
